...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO schooldetails (schoolID, schoolname, schooladdress, logo, nearestTown) VALUES (%s, %s, %s, %s, %s)",
  ...
  {
	  echo '<script>alert("A school already exists")</script>';
  }
...
<table width="100%" border="0">
  <tr>
    <td><fieldset> <legend style="margin-left:50%;" >Enter school details</legend>
        <p><center>
        ...
        <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
          <table align="center">
            ...
            <tr valign="baseline">
              ...
              <td><input type="submit" value="Register School" />               <input type="reset" name="Reset" id="button" value="Refresh Page" /></td>
            </tr>
          </table>
